  ...
  <?php foreach ($build as $row) :?>
    <div class="six columns feature" role="article">
      ...
      <?php for ($story = 1; $story < 4; $story++) :?>
        ...
        <li><a href="<?php echo $row[$story_num]['story_permalink'] ?>" class="external" rel="noopener noreferrer" data-outgoing="<?php echo $row[$story_num]['story_hash'] ?>"><?php echo $row[$story_num]['story_title'] ?></a></li>
        <?php endif; ?>
